...
For each tool, there are specific failure mode for how the agent reponds to errors.
...
Full user interaction looks like from start to finish — tool call by tool call. With a specific example query.
